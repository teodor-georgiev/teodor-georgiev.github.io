...
As a part of my master thesis i was given the task to build an interactive web-based dashboard using Dash and Plotly to vizualise how consumers perceive different brands. The dashboard consists of two parts. First it vizualizes the results from the research paper ["Mining Brand Perceptions from Twitter Social Networks"](http://dx.doi.org/10.1287/mksc.2015.0968) by Aron Culotta and Jennifer Cutler from 2016 published in Marketing Science. The second part vizualizes the impact of brand perceptions on the stock market for five different brands including Apple, Coca-Cola, H&M, Nike and Starbucks. The data used is from three different sources including Twitter, Stocktwits and the marketing research company YouGov.
