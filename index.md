...
This project serves as an example of online retailer analysis using Python to build a classifier that predicts if an ordered item will be returned or not. The dataset used in this analysis comes from the Data Mining Cup 2014 and contains over 530,000 items ordered by a German online clothing retailer over a 13-month period. The features describe both the items and the customer who placed the order. The models used to predict the return of an item include Neural Network, XGBoost, CatBoost, and LightGBM. The best-performing model was CatBoost (GPU), achieving an MAE of 0.2974 on the test set and placing the solution in the top 4 of the ranking list of the Data Mining Cup 2014.
